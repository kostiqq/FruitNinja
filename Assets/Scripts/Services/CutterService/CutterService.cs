    ...
    public class CutterService : MonoBehaviour, ICutterService
    {
        ...
        public void Cut(ColliderComponent colliderObject, Vector3 normalized)
        {
            ...
            var leftPart = CreatePart(fruit,
                new Rect(currentSpriteRect.x, currentSpriteRect.y, currentSpriteRect.width / 2,
                    currentSpriteRect.height),
                new Vector2(1f, 0.5f));
            var rightPart = CreatePart(fruit,
                new Rect(currentSpriteRect.x + currentSpriteRect.width / 2, currentSpriteRect.y,
                    currentSpriteRect.width / 2, currentSpriteRect.height),
                new Vector2(0f, 0.5f));
